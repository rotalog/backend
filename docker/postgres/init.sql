...
--
-- O Docker monta este arquivo em:
--   /docker-entrypoint-initdb.d/
-- e o Postgres o roda antes de aceitar conexões.
-- =====================================================

-- Habilita a extensão PostGIS no banco sistema_db
...
CREATE TABLE IF NOT EXISTS customers (
    ...
    birth_date  DATE,
    active      BOOLEAN         NOT NULL DEFAULT TRUE,
    -- Coluna geográfica: localização do cliente (lat/lng)
    -- Tipo GEOGRAPHY do PostGIS com SRID 4326 (WGS84 – padrão GPS)
...
CREATE INDEX IF NOT EXISTS idx_distributors_tax_id  ON distributors(tax_id);
...
-- -----------------------------------------------
-- ÍNDICES ESPACIAIS (GIST) – necessários para
-- consultas geográficas performáticas com PostGIS
-- -----------------------------------------------
...
CREATE INDEX IF NOT EXISTS idx_orders_delivery_route ON orders       USING GIST(delivery_route);
